...
public class BinarySearchTreeNode {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Maximum element in the BST using Non-Recursion: " + BT.findMax_BST_Non_Recursive(BT.root).data);
        ...
        System.out.println("After inserting the value in the BST using non-recursion: " + BT.root.right.right.right.data);
