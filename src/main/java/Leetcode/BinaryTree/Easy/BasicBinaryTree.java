...
public class BasicBinaryTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(
            "Maximum number of nodes in the tree: " + basicBinaryTree.numberOfNodes(basicBinaryTree.root));
        ...
        System.out.println();
        System.out.println(
            "Number of Leaf Nodes in the tree: " + basicBinaryTree.numberOfLeafNodes(basicBinaryTree.root));

        System.out.println();
        if (basicBinaryTree.BTreeSearch(basicBinaryTree.root, 2) != null) {
            System.out.println(
                "Searching this node in the Binary Tree: " + basicBinaryTree.BTreeSearch(basicBinaryTree.root, 2).data);
        } else {
            System.out.println(
                "Searching this node in the Binary Tree: " + basicBinaryTree.BTreeSearch(basicBinaryTree.root, 2));
        }
