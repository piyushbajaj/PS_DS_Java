...
public class checkingMirror {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "Root (" + BT1.root.data + ") -> Left (" + BT1.root.left.data + ") -> Left: " + BT1.root.left.left.data);
        BT1.root.left.right = new Node(5);
        System.out.println(
            "Root (" + BT1.root.data + ") -> Left (" + BT1.root.left.data + ") -> Right: " + BT1.root.left.right.data);
        BT1.root.right.left = new Node(6);
        System.out.println(
            "Root (" + BT1.root.data + ") -> Right (" + BT1.root.right.data + ")-> Left: " + BT1.root.right.left.data);
        BT1.root.right.right = new Node(7);
        System.out.println("Root (" + BT1.root.data + ") -> Right (" + BT1.root.right.data + ") -> Right: " +
            BT1.root.right.right.data);
        ...
        System.out.println(
            "Root (" + BT2.root.data + ") -> Left (" + BT2.root.left.data + ") -> Left: " + BT2.root.left.left.data);
        BT2.root.left.right = new Node(6);
        System.out.println(
            "Root (" + BT2.root.data + ") -> Left (" + BT2.root.left.data + ") -> Right: " + BT2.root.left.right.data);
        BT2.root.right.left = new Node(5);
        System.out.println(
            "Root (" + BT2.root.data + ") -> Right (" + BT2.root.right.data + ")-> Left: " + BT2.root.right.left.data);
        BT2.root.right.right = new Node(4);
        System.out.println("Root (" + BT2.root.data + ") -> Right (" + BT2.root.right.data + ") -> Right: " +
            BT2.root.right.right.data);
