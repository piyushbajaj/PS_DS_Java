...
public class sizeOfBT {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            "Height of a Binary Tree from Root using recursive is: " + BT.heightOfBinaryTree_Recursive(BT.root));

        System.out.println(
            "Height of a Binary Tree from Root using stack is: " + BT.heightOfBinaryTree_Using_Stack(BT.root));
